...
class NominatimProvider extends AbstractProvider
{
    ...
    protected $REVERSE_URL = 'https://nominatim.openstreetmap.org/reverse?format=json&lat=%s&lon=%s';

    protected $GEOCODE_URL = 'https://nominatim.openstreetmap.org/search?format=json&street=%s&city=%s&postalcode=%s&addressdetails=1';
